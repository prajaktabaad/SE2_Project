      ...
      <div class="card text-center border-0">
        ...
        <?php
            ...
            if($row > 0){
              ...
              $user_name=$row['w_name'];
              echo "<img src='./warden_images/$user_image' class='img-fluid rounded-circle mb-4' alt=''>
        ...
        ?>
          ...
          <?php
            ...
            $row=mysqli_fetch_array($result);
    ?>
            <li><strong>Email:</strong> <?php echo $row['w_email']; ?></li>
            <li><strong>Contact:</strong> <?php echo $row['w_mobile']; ?></li>
          </ul>
</div>
