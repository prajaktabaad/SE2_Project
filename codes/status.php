...
<div class="container">
  <div class="row align-items-center justify-content-center">
    ...
    $user_mis=$_SESSION['MIS']; 
    $user_details="select * from `nightout` where S_MIS=$user_mis";
    $result=mysqli_query($con,$user_details);
    $row=mysqli_fetch_array($result);
    $row_count=mysqli_num_rows($result);
    if($row_count<=0){
        echo "<p class='no-applications'>No Pending Applications</p>";
    }
    else{
        $sname = $row['S_name'];
        $smis = $row['S_MIS'];
        ...
        $sto = $row['to_date'];
        $status = $row['approve'];
        echo"<strong>Name: </strong> $sname <br>";
        echo"<strong>MIS: </strong> $smis <br>";
        echo"<strong>Room No: </strong> $sroom<br>";
        echo"<strong>Email: </strong> $semail<br>";
        echo"<strong>Parents Email: </strong> $spemail<br>";
        echo"<strong>Address: </strong> $saddress<br>";
        echo"<strong>From: </strong> $sfrom<br>";
        echo"<strong>To: </strong> $sto<br>";
        echo"<strong>Status: </strong><span style='color:red;'> $status</span><br>";
    }
?>
          </ul>
        </div>
