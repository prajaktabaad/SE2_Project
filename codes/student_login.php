                ...
                <form action="" method="post">
                    <div class="form-floating mb-3">
                        <input type="text" id="MIS" name="MIS"
                         placeholder="Enter Your MIS" required="required" class="form-control">
                        <label for="MIS" class="form-label">MIS</label>
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="d-grid gap-2 mb-4">
                        <input type="submit" name="student_login" id="login-btn" class="btn btn-primary" value="Login">
                    </div>
                    <div class="text-center">
                        <p class="small fw-bold mb-1">Don't You Have an account?</p>
                        <a href="#" class="text-decoration-none" id="contact-wardens">Contact Wardens</a>
                    </div>
                </form>
            </div>
      </div>
...
if(isset($_POST['student_login'])){
    ...
    if($row_count>0){
        $_SESSION['MIS']=$user_mis;
        if(password_verify($user_password,$row_data['s_password'])){
