...
<?php
    $get_attendence="select * from `nightout`"; 
    $result=mysqli_query($con,$get_attendence);
    $row_count=mysqli_num_rows($result);
    if($row_count<=0){
        echo "<h3 class='text-success'>No Application</h3>";
    }else{
    echo "<h3 class='text-success'>NightOuts</h3>
                    ...
                    echo "<tr>
                            ...
                            <?php
                                if($status=='Approved'){
                                    ...
                                    echo "<td><a href='confirm.php?id=$ID' class='text-light text-decoration-none'>Confirm</a></td>
                                    </tr>";
                                }
